...
REDIRECT_MAP = {
    ...
    # memory how-tos
    "how-tos/memory/manage-conversation-history.ipynb": "how-tos/memory.md",
    "how-tos/memory/delete-messages.ipynb": "how-tos/memory.md#delete-messages",
    "how-tos/memory/add-summary-conversation-history.ipynb": "how-tos/memory.md#summarize-messages",
    "how-tos/memory.ipynb": "how-tos/memory.md",
    "agents/memory.ipynb": "how-tos/memory.md",
    # subgraph how-tos
    ...
    # persistence how-tos
    "how-tos/persistence_postgres.ipynb": "how-tos/memory.md#use-in-production",
    "how-tos/persistence_mongodb.ipynb": "how-tos/memory.md#use-in-production",
    "how-tos/persistence_redis.ipynb": "how-tos/memory.md#use-in-production",
    "how-tos/subgraph-persistence.ipynb": "how-tos/memory.md#use-with-subgraphs",
    "how-tos/cross-thread-persistence.ipynb": "how-tos/memory.md#add-long-term-memory",
    "cloud/how-tos/copy_threads": "cloud/how-tos/use_threads",
    "cloud/concepts/threads.md": "concepts/persistence.md#threads",
    "how-tos/persistence.ipynb": "how-tos/memory.md",
