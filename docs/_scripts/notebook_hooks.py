...
REDIRECT_MAP = {
    # lib redirects
    "how-tos/stream-values.ipynb": "https://docs.langchain.com/oss/python/langgraph/use-streaming#stream-graph-state",
    "how-tos/stream-updates.ipynb": "https://docs.langchain.com/oss/python/langgraph/use-streaming#stream-graph-state",
    "how-tos/streaming-content.ipynb": "https://docs.langchain.com/oss/python/langgraph/use-streaming",
    "how-tos/stream-multiple.ipynb": "https://docs.langchain.com/oss/python/langgraph/use-streaming#stream-multiple-nodes",
    "how-tos/streaming-tokens-without-langchain.ipynb": "https://docs.langchain.com/oss/python/langgraph/use-streaming#use-with-any-llm",
    "how-tos/streaming-from-final-node.ipynb": "https://docs.langchain.com/oss/python/langgraph/use-streaming",
    "how-tos/streaming-events-from-within-tools-without-langchain.ipynb": "https://docs.langchain.com/oss/python/langgraph/use-streaming#example-without-langchain",
    # graph-api
    ...
    "how-tos/tool-calling-errors.ipynb": "https://docs.langchain.com/oss/python/langgraph/call-tools#handle-errors",
    "how-tos/pass-config-to-tools.ipynb": "https://docs.langchain.com/oss/python/langgraph/call-tools#access-config",
    "how-tos/pass-run-time-values-to-tools.ipynb": "https://docs.langchain.com/oss/python/langgraph/call-tools#read-state",
    "how-tos/update-state-from-tools.ipynb": "https://docs.langchain.com/oss/python/langgraph/call-tools#update-state",
    "agents/tools.md": "https://docs.langchain.com/oss/python/langgraph/call-tools",
    # multi-agent how-tos
    "how-tos/agent-handoffs.ipynb": "https://docs.langchain.com/oss/python/langgraph/multi-agent-custom#handoffs",
    "how-tos/multi-agent-network.ipynb": "https://docs.langchain.com/oss/python/langgraph/multi-agent-custom#use-in-a-multi-agent-system",
    "how-tos/multi-agent-multi-turn-convo.ipynb": "https://docs.langchain.com/oss/python/langgraph/multi-agent-custom#multi-turn-conversation",
    # cloud redirects
    "cloud/index.md": "https://docs.langchain.com/oss/python/langgraph/overview",
    "cloud/how-tos/index.md": "https://docs.langchain.com/langsmith/index",
    ...
    "cloud/faq/studio.md": "https://docs.langchain.com/langsmith/langgraph-studio#studio-faqs",
    ...
    "agents/streaming.md": "https://docs.langchain.com/oss/python/langgraph/use-streaming",
    # prebuilt redirects
    ...
    "how-tos/create-react-agent-system-prompt.ipynb": "https://docs.langchain.com/oss/python/langgraph/context#prompts",
    ...
    "tutorials/introduction.ipynb": "https://docs.langchain.com/oss/python/langgraph/why-langgraph",
    "agents/deployment.md": "https://docs.langchain.com/oss/python/langgraph/local-server",
    # deployment redirects
    "how-tos/deploy-self-hosted.md": "https://docs.langchain.com/langsmith/deploy-self-hosted-data-plane",
    "concepts/self_hosted.md": "https://docs.langchain.com/langsmith/self-hosted-data-plane",
    ...
    "how-tos/create-react-agent-hitl.ipynb": "https://docs.langchain.com/oss/python/langgraph/add-human-in-the-loop",
    "agents/human-in-the-loop.md": "https://docs.langchain.com/oss/python/langgraph/add-human-in-the-loop",
    "how-tos/human_in_the_loop/dynamic_breakpoints.ipynb": "https://docs.langchain.com/oss/python/langgraph/add-human-in-the-loop",
    "concepts/breakpoints.md": "https://docs.langchain.com/oss/python/langgraph/interrupts",
    "how-tos/human_in_the_loop/breakpoints.md": "https://docs.langchain.com/oss/python/langgraph/add-human-in-the-loop",
    ...
    "concepts/why-langgraph.md": "https://docs.langchain.com/oss/python/langgraph/why-langgraph",
    ...
    "tutorials/workflows.md": "https://docs.langchain.com/oss/python/langgraph/agentic-architectures",
    "concepts/agentic_concepts.md": "https://docs.langchain.com/oss/python/langgraph/agentic-architectures",
    ...
    "agents/run_agents.md": "https://docs.langchain.com/oss/python/langgraph/run-an-agent",
    ...
    "how-tos/streaming.md": "https://docs.langchain.com/oss/python/langgraph/use-streaming",
    ...
    "agents/context.md": "https://docs.langchain.com/oss/python/langgraph/context",
    "agents/models.md": "https://docs.langchain.com/oss/python/langgraph/models",
    "concepts/tools.md": "https://docs.langchain.com/oss/python/langgraph/tools",
    "how-tos/tool-calling.md": "https://docs.langchain.com/oss/python/langgraph/call-tools",
    "concepts/human_in_the_loop.md": "https://docs.langchain.com/oss/python/langgraph/interrupts",
    "how-tos/human_in_the_loop/add-human-in-the-loop.md": "https://docs.langchain.com/oss/python/langgraph/add-human-in-the-loop",
    "concepts/time-travel.md": "https://docs.langchain.com/oss/python/langgraph/time-travel",
    "how-tos/human_in_the_loop/time-travel.md": "https://docs.langchain.com/oss/python/langgraph/use-time-travel",
    "concepts/subgraphs.md": "https://docs.langchain.com/oss/python/langgraph/subgraphs",
    "how-tos/subgraph.md": "https://docs.langchain.com/oss/python/langgraph/use-subgraphs",
    "concepts/multi_agent.md": "https://docs.langchain.com/oss/python/langgraph/multi-agent-supervisor",
    "agents/multi-agent.md": "https://docs.langchain.com/oss/python/langchain/multi-agent",
    "how-tos/multi_agent.md": "https://docs.langchain.com/oss/python/langgraph/multi-agent-custom",
    "concepts/mcp.md": "https://docs.langchain.com/oss/python/langgraph/mcp",
    "agents/mcp.md": "https://docs.langchain.com/oss/python/langgraph/use-mcp",
    "concepts/tracing.md": "https://docs.langchain.com/oss/python/langgraph/trace-agent",
    "how-tos/enable-tracing.md": "https://docs.langchain.com/oss/python/langgraph/trace-agent",
    "agents/evals.md": "https://docs.langchain.com/oss/python/langgraph/evals",
    "examples/index.md": "https://docs.langchain.com/oss/python/langgraph/case-studies",
    "concepts/template_applications.md": "https://docs.langchain.com/oss/python/langgraph/template-applications",
    "tutorials/rag/langgraph_agentic_rag.md": "https://docs.langchain.com/oss/python/langgraph/agentic-rag",
    "tutorials/multi_agent/agent_supervisor.md": "https://docs.langchain.com/oss/python/langgraph/agent-supervisor",
    ...
    "how-tos/run-id-langsmith.md": "https://docs.langchain.com/oss/python/langgraph/run-id-langsmith",
    ...
    "concepts/faq.md": "https://docs.langchain.com/oss/python/langgraph/faq",
    ...
    "cloud/deployment/egress.md": "https://docs.langchain.com/langsmith/env-var",
    "cloud/deployment/graph_rebuild.md": "https://docs.langchain.com/langsmith/graph-rebuild",
    "cloud/deployment/self_hosted_control_plane.md": "https://docs.langchain.com/langsmith/deploy-self-hosted-control-plane",
    "cloud/deployment/self_hosted_data_plane.md": "https://docs.langchain.com/langsmith/deploy-self-hosted-data-plane",
    "cloud/deployment/semantic_search.md": "https://docs.langchain.com/langsmith/semantic-search",
    "cloud/deployment/setup_javascript.md": "https://docs.langchain.com/langsmith/setup-javascript",
    "cloud/deployment/setup_pyproject.md": "https://docs.langchain.com/langsmith/setup-pyproject",
    "cloud/deployment/setup.md": "https://docs.langchain.com/langsmith/setup-app-requirements-txt",
    "cloud/deployment/standalone_container.md": "https://docs.langchain.com/langsmith/deploy-standalone-container",
    "cloud/how-tos/add-human-in-the-loop.md": "https://docs.langchain.com/langsmith/add-human-in-the-loop",
    "cloud/how-tos/background_run.md": "https://docs.langchain.com/langsmith/background-run",
    "cloud/how-tos/clone_traces_studio.md": "https://docs.langchain.com/langsmith/clone-traces-studio",
    "cloud/how-tos/configurable_headers.md": "https://docs.langchain.com/langsmith/configurable-headers",
    ...
    "cloud/how-tos/iterate_graph_studio.md": "https://docs.langchain.com/langsmith/iterate-graph-studio",
    "cloud/how-tos/reject_concurrent.md": "https://docs.langchain.com/langsmith/reject-concurrent",
    "cloud/how-tos/rollback_concurrent.md": "https://docs.langchain.com/langsmith/rollback-concurrent",
    "cloud/how-tos/same-thread.md": "https://docs.langchain.com/langsmith/same-thread",
    "cloud/how-tos/stateless_runs.md": "https://docs.langchain.com/langsmith/stateless-runs",
    "cloud/how-tos/streaming.md": "https://docs.langchain.com/langsmith/streaming",
    "cloud/how-tos/studio/manage_assistants.md": "https://docs.langchain.com/langsmith/manage-assistants-studio",
    "cloud/how-tos/studio/quick_start.md": "https://docs.langchain.com/langsmith/quick-start-studio",
    "cloud/how-tos/studio/run_evals.md": "https://docs.langchain.com/langsmith/run-evals-studio",
    ...
    "concepts/langgraph_self_hosted_control_plane.md": "https://docs.langchain.com/langsmith/self-hosted-control-plane",
    "concepts/langgraph_self_hosted_data_plane.md": "https://docs.langchain.com/langsmith/self-hosted-data-plane",
    "concepts/langgraph_server.md": "https://docs.langchain.com/langsmith/langgraph-server",
    "concepts/langgraph_standalone_container.md": "https://docs.langchain.com/langsmith/standalone-container",
    ...
    "agents/agents.md": "https://docs.langchain.com/oss/python/langchain/agents",
    "concepts/why-langgraph.md": "https://docs.langchain.com/oss/python/langgraph/why-langgraph",
    "tutorials/get-started/1-build-basic-chatbot.md": "https://docs.langchain.com/oss/python/langgraph/1-build-basic-chatbot",
    "tutorials/get-started/2-add-tools.md": "https://docs.langchain.com/oss/python/langgraph/2-add-tools",
    "tutorials/get-started/3-add-memory.md": "https://docs.langchain.com/oss/python/langgraph/3-add-memory",
    "tutorials/get-started/4-human-in-the-loop.md": "https://docs.langchain.com/oss/python/langgraph/4-human-in-the-loop",
    "tutorials/get-started/5-customize-state.md": "https://docs.langchain.com/oss/python/langgraph/5-customize-state",
    "tutorials/get-started/6-time-travel.md": "https://docs.langchain.com/oss/python/langgraph/6-time-travel",
    "tutorials/langsmith/local-server.md": "https://docs.langchain.com/oss/python/langgraph/local-server",
    "tutorials/workflows.md": "https://docs.langchain.com/oss/python/langgraph/agentic-architectures",
    "concepts/agentic_concepts.md": "https://docs.langchain.com/oss/python/langgraph/agentic-architectures",
    "guides/index.md": "https://docs.langchain.com/oss/python/langchain/overview",
