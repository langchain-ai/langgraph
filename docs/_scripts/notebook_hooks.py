...
REDIRECT_MAP = {
    ...
    "concepts/low_level.md": "https://docs.langchain.com/oss/python/langgraph/use-graph-api",
    "how-tos/graph-api.md": "https://docs.langchain.com/oss/python/langgraph/use-graph-api",
    "concepts/functional_api.md": "https://docs.langchain.com/oss/python/langgraph/functional-api",
    "how-tos/use-functional-api.md": "https://docs.langchain.com/oss/python/langgraph/use-functional-api",
