...
REDIRECT_MAP = {
    ...
    "concepts/langgraph_platform.md": "https://docs.langchain.com/langgraph-platform/langgraph-platform",
    "concepts/langgraph_components.md": "https://docs.langchain.com/langgraph-platform/langgraph-components",
    ...
    "concepts/langgraph_cli.md": "https://docs.langchain.com/langgraph-platform/cli",
    ...
    "concepts/langgraph_self_hosted_data_plane.md": "https://docs.langchain.com/langgraph-platform/langgraph-self-hosted-data-plane",
    "concepts/langgraph_self_hosted_control_plane.md": "https://docs.langchain.com/langgraph-platform/langgraph-self-hosted-control-plane",
    "concepts/langgraph_standalone_container.md": "https://docs.langchain.com/langgraph-platform/langgraph-standalone-container",
