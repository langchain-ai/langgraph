...
REDIRECT_MAP = {
    ...
    "agents/deployment.md": "https://docs.langchain.com/oss/python/local-server",
    ...
    "index.md": "https://docs.langchain.com/oss/python/overview",
    "agents/agents.md": "https://docs.langchain.com/oss/python/prebuilts",
    "concepts/why-langgraph.md": "https://docs.langchain.com/oss/python/why-langgraph",
    "tutorials/get-started/1-build-basic-chatbot.md": "https://docs.langchain.com/oss/python/1-build-basic-chatbot",
    "tutorials/get-started/2-add-tools.md": "https://docs.langchain.com/oss/python/2-add-tools",
    "tutorials/get-started/3-add-memory.md": "https://docs.langchain.com/oss/python/3-add-memory",
    "tutorials/get-started/4-human-in-the-loop.md": "https://docs.langchain.com/oss/python/4-human-in-the-loop",
    "tutorials/get-started/5-customize-state.md": "https://docs.langchain.com/oss/python/5-customize-state",
    "tutorials/get-started/6-time-travel.md": "https://docs.langchain.com/oss/python/6-time-travel",
    "tutorials/langgraph-platform/local-server.md": "https://docs.langchain.com/oss/python/local-server",
    "tutorials/workflows.md": "https://docs.langchain.com/oss/python/agentic-architectures",
    "concepts/agentic_concepts.md": "https://docs.langchain.com/oss/python/agentic-architectures",
    "guides/index.md": "https://docs.langchain.com/oss",
    "agents/overview.md": "https://docs.langchain.com/oss/python/prebuilts",
    "agents/run_agents.md": "https://docs.langchain.com/oss/python/run-an-agent",
    "concepts/low_level.md": "https://docs.langchain.com/oss/python/use-graph-api",
    "how-tos/graph-api.md": "https://docs.langchain.com/oss/python/use-graph-api",
    "concepts/functional_api.md": "https://docs.langchain.com/oss/python/functional-api",
    "how-tos/use-functional-api.md": "https://docs.langchain.com/oss/python/use-functional-api",
    "concepts/pregel.md": "https://docs.langchain.com/oss/python/pregel",
    "concepts/streaming.md": "https://docs.langchain.com/oss/python/streaming",
    "how-tos/streaming.md": "https://docs.langchain.com/oss/python/use-streaming",
    "concepts/persistence.md": "https://docs.langchain.com/oss/python/persistence",
    "concepts/durable_execution.md": "https://docs.langchain.com/oss/python/durable-execution",
    "concepts/memory.md": "https://docs.langchain.com/oss/python/memory",
    "how-tos/memory/add-memory.md": "https://docs.langchain.com/oss/python/add-memory",
    "agents/context.md": "https://docs.langchain.com/oss/python/context",
    "agents/models.md": "https://docs.langchain.com/oss/python/models",
    "concepts/tools.md": "https://docs.langchain.com/oss/python/tools",
    "how-tos/tool-calling.md": "https://docs.langchain.com/oss/python/call-tools",
    "concepts/human_in_the_loop.md": "https://docs.langchain.com/oss/python/human-in-the-loop",
    "how-tos/human_in_the_loop/add-human-in-the-loop.md": "https://docs.langchain.com/oss/python/add-human-in-the-loop",
    "concepts/time-travel.md": "https://docs.langchain.com/oss/python/time-travel",
    "how-tos/human_in_the_loop/time-travel.md": "https://docs.langchain.com/oss/python/use-time-travel",
    "concepts/subgraphs.md": "https://docs.langchain.com/oss/python/subgraphs",
    "how-tos/subgraph.md": "https://docs.langchain.com/oss/python/use-subgraphs",
    "concepts/multi_agent.md": "https://docs.langchain.com/oss/python/multi-agent-supervisor",
    "agents/multi-agent.md": "https://docs.langchain.com/oss/python/multi-agent-prebuilts",
    "how-tos/multi_agent.md": "https://docs.langchain.com/oss/python/multi-agent-custom",
    "concepts/mcp.md": "https://docs.langchain.com/oss/python/mcp",
    "agents/mcp.md": "https://docs.langchain.com/oss/python/use-mcp",
    "concepts/tracing.md": "https://docs.langchain.com/oss/python/trace-agent",
    "how-tos/enable-tracing.md": "https://docs.langchain.com/oss/python/trace-agent",
    "agents/evals.md": "https://docs.langchain.com/oss/python/evals",
    "examples/index.md": "https://docs.langchain.com/oss/python/case-studies",
    "concepts/template_applications.md": "https://docs.langchain.com/oss/python/template-applications",
    "tutorials/rag/langgraph_agentic_rag.md": "https://docs.langchain.com/oss/python/agentic-rag",
    "tutorials/multi_agent/agent_supervisor.md": "https://docs.langchain.com/oss/python/agent-supervisor",
    "tutorials/sql/sql-agent.md": "https://docs.langchain.com/oss/python/sql-agent",
    "agents/ui.md": "https://docs.langchain.com/oss/python/ui",
    "how-tos/run-id-langsmith.md": "https://docs.langchain.com/oss/python/run-id-langsmith",
    "troubleshooting/errors/index.md": "https://docs.langchain.com/oss/python/common-errors",
    "troubleshooting/errors/INVALID_CHAT_HISTORY.md": "https://docs.langchain.com/oss/python/INVALID_CHAT_HISTORY",
    "troubleshooting/errors/INVALID_LICENSE.md": "https://docs.langchain.com/oss/python/common-errors",
    "adopters.md": "https://docs.langchain.com/oss/python/case-studies",
    "concepts/faq.md": "https://docs.langchain.com/oss/python/faq",
    "agents/prebuilt.md": "https://docs.langchain.com/oss/python/prebuilts",

    # additional exclude-search entries from mkdocs.yml
    "additional-resources/index.md": "https://docs.langchain.com/oss",
    "cloud/concepts/cron_jobs.md": "https://docs.langchain.com/langgraph-platform/cron-jobs",
    "cloud/concepts/data_storage_and_privacy.md": "https://docs.langchain.com/langgraph-platform/data-storage-and-privacy",
    "cloud/concepts/webhooks.md": "https://docs.langchain.com/langgraph-platform/use-webhooks",
    "cloud/deployment/cloud.md": "https://docs.langchain.com/langgraph-platform/cloud",
    ...
    "cloud/reference/env_var.md": "https://docs.langchain.com/langgraph-platform/env-var",
    "cloud/reference/langgraph_server_changelog.md": "https://docs.langchain.com/langgraph-platform/langgraph-server-changelog",
    "cloud/reference/sdk/js_ts_sdk_ref.md": "https://docs.langchain.com/langgraph-platform/js-ts-sdk",
    "concepts/application_structure.md": "https://docs.langchain.com/langgraph-platform/application-structure",
    "concepts/assistants.md": "https://docs.langchain.com/langgraph-platform/assistants",
    "concepts/auth.md": "https://docs.langchain.com/langgraph-platform/auth",
    "concepts/deployment_options.md": "https://docs.langchain.com/langgraph-platform/deployment-options",
    ...
    "how-tos/use-remote-graph.md": "https://docs.langchain.com/langgraph-platform/use-remote-graph",
    "index.md": "https://docs.langchain.com/oss/python/overview",
    "snippets/chat_model_tabs.md": "https://docs.langchain.com/oss",
    "troubleshooting/errors/GRAPH_RECURSION_LIMIT.md": "https://docs.langchain.com/oss/python/GRAPH_RECURSION_LIMIT",
    "troubleshooting/errors/index.md": "https://docs.langchain.com/oss/python/common-errors",
    "troubleshooting/errors/INVALID_CHAT_HISTORY.md": "https://docs.langchain.com/oss/python/INVALID_CHAT_HISTORY",
    "troubleshooting/errors/INVALID_CONCURRENT_GRAPH_UPDATE.md": "https://docs.langchain.com/oss/python/INVALID_CONCURRENT_GRAPH_UPDATE",
    "troubleshooting/errors/INVALID_GRAPH_NODE_RETURN_VALUE.md": "https://docs.langchain.com/oss/python/INVALID_GRAPH_NODE_RETURN_VALUE",
    "troubleshooting/errors/INVALID_LICENSE.md": "https://docs.langchain.com/oss/python/common-errors",
    "troubleshooting/errors/MULTIPLE_SUBGRAPHS.md": "https://docs.langchain.com/oss/python/MULTIPLE_SUBGRAPHS",
    "troubleshooting/studio.md": "https://docs.langchain.com/langgraph-platform/troubleshooting-studio",
    "tutorials/auth/add_auth_server.md": "https://docs.langchain.com/langgraph-platform/add-auth-server",
    "tutorials/auth/getting_started.md": "https://docs.langchain.com/langgraph-platform/auth",
    "tutorials/auth/resource_auth.md": "https://docs.langchain.com/langgraph-platform/resource-auth",
