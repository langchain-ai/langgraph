...
REDIRECT_MAP = {
    ...
    "snippets/chat_model_tabs.md": "https://docs.langchain.com/oss/overview",
    ...
    "troubleshooting/studio.md": "https://docs.langchain.com/oss/overview",
    "tutorials/auth/add_auth_server.md": "https://docs.langchain.com/oss/overview",
    "tutorials/auth/getting_started.md": "https://docs.langchain.com/oss/overview",
    "tutorials/auth/resource_auth.md": "https://docs.langchain.com/oss/overview",
    ...
    "tutorials/langgraph-platform/local-server.md": "https://docs.langchain.com/oss/quickstart",
    "tutorials/workflows.md": "https://docs.langchain.com/oss/workflows",
    ...
    "agents/overview.md": "https://docs.langchain.com/oss/agentic-architectures",
    "agents/run_agents.md": "https://docs.langchain.com/oss/run-agents",
    "concepts/low_level.md": "https://docs.langchain.com/oss/low-level",
    "how-tos/graph-api.md": "https://docs.langchain.com/oss/graph-api",
    ...
    "concepts/durable_execution.md": "https://docs.langchain.com/oss/durableeexecution",
    ...
    "concepts/tracing.md": "https://docs.langchain.com/oss/tracing",
    "how-tos/enable-tracing.md": "https://docs.langchain.com/oss/tracing",
    ...
    "agents/prebuilt.md": "https://docs.langchain.com/oss/prebuilt",
}
