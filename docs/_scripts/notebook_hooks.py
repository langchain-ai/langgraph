...
REDIRECT_MAP = {
    ...
    "concepts/langgraph_self_hosted_data_plane.md": "concepts/self_hosted.md#self-hosted-data-plane-beta",
    "concepts/langgraph_self_hosted_control_plane.md": "concepts/self_hosted.md#self-hosted-control-plane-beta"
}
