...
The **Functional API** allows you to add LangGraph's key features -- [persistence](./persistence.md)/[memory](./memory.md), [human-in-the-loop](./human_in_the_loop.md) workflows, and [streaming](./streaming) — to your applications with minimal changes to your existing code.
