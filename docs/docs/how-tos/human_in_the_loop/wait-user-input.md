...
In the context of [agents](../../../concepts/agentic_concepts.md), waiting for user feedback is especially useful for asking clarifying questions. To illustrate this, we’ll create a simple [ReAct-style agent](../../../concepts/agentic_concepts#react-implementation.md) capable of [tool calling](https://python.langchain.com/docs/concepts/tool_calling/). 
