...
You can [compile](https://langchain-ai.github.io/langgraph/reference/graphs/#langgraph.graph.MessageGraph.compile) any LangGraph workflow with a [CheckPointer](){#langgraph.checkpoint.Checkpoint.versions_seen} to give your agent "memory" by persisting its state. This permits things like:
