...
# Page size for stage-1 paged scan in `get_delta_writes`. Internal
...
class BasePostgresSaver(BaseCheckpointSaver[str]):
    ...
    def _build_delta_channels_writes_history(
        ...
        *,
        ...
        a `DeltaWrites` per requested channel. The `seed` key is omitted
        ...
        for ch in channels:
            ...
            entry: DeltaWrites = {"writes": collected}
