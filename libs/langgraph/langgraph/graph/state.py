...
class StateGraph(Graph):
    ...
    def add_node(
        ...
        *,
        ...
        annotations: Optional[Union[dict[str, str], tuple[str]]] = None,
    ) -> Self:
    ...
    def add_node(
        ...
        *,
        ...
        Args:
            ...
            annotations (Optional[Union[dict[str, str], tuple[str]]]): Annotations that indicate where a node can route to.
