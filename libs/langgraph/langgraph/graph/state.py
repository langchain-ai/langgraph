        ...
        def _get_updates(
            ...
            if input is None:
                ...
                if output_keys != ["__root__"]:
                    ...
                    if dropped:
                        warnings.warn(
                            f"Node {key!r} returned keys {dropped!r} that are not "
                            f"declared in the state schema and will be dropped. "
                            f"Declare them in your TypedDict/schema to persist them.",
                            UserWarning,
                            stacklevel=5,
                        )
