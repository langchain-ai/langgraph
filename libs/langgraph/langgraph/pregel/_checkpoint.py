...
def channels_from_checkpoint(
    ...
    *,
    ...
    `saver.get_delta_writes` is required to find the nearest seed
    ...
    if delta_channels and saver is not None and config is not None:
        histories = saver.get_delta_writes(config=config, channels=delta_channels)
...
async def achannels_from_checkpoint(
    ...
    *,
    ...
    histories: Mapping[str, Any] = {}
    if delta_channels and saver is not None and config is not None:
        histories = await saver.aget_delta_writes(
