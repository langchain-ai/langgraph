...
def get_function_nonlocals(func: Callable) -> list[Any]:
    ...
    # Captured values count whether or not the bytecode still names them: the
    # compiler drops instructions for unreachable code but keeps the closure,
    # so `if False: sub.invoke()` is visible here and nowhere else.
