    ...
    def _get_stream_modes(
        ...
        if stream_mode:
            if isinstance(stream_mode, str):
                ...
                req_single = False
                updated_stream_modes.extend(cast(StreamModeSDK, m) for m in stream_mode)
        else:
            updated_stream_modes.append(cast(StreamModeSDK, default))
        ...
        if stream:
            updated_stream_modes.extend(cast(StreamModeSDK, m) for m in stream.modes)
