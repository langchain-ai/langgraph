...
def test_config_json_schema(use_node_builder: bool) -> None:
    ...
    if use_node_builder:
        ...
        chain = Channel.subscribe_only("input") | Channel.write_to("output")
...
def test_invoke_single_process_in_out(
    ...
    if use_node_builder:
        ...
        chain = Channel.subscribe_only("input") | add_one | Channel.write_to("output")
...
def test_invoke_two_processes_in_out(
    ...
    if use_node_builder:
        ...
        one = Channel.subscribe_only("input") | add_one | Channel.write_to("inbox")
        two = Channel.subscribe_only("inbox") | add_one | Channel.write_to("output")
