...
class ToolNode(RunnableCallable):
    ...
    def _run_one(
        ...
        try:
            ...
            # GraphInterrupt / ParentCommand are control-flow, not tool errors.
            # The direct path already re-raises these; wrap_tool_call must too.
            raise
        except Exception as e:
    ...
    async def _arun_one(
        ...
        try:
            ...
            # GraphInterrupt / ParentCommand are control-flow, not tool errors.
            # The direct path already re-raises these; awrap_tool_call must too.
            raise
        except Exception as e:
            # Wrapper threw an exception
            if not self._handle_tool_errors:
